...
![Import page](../../_assets/user-guide/import/import-page.jpg)
...
Click the `Choose File` button to load the import file in the CSV format. All the data in this file should be UTF-8 encoded. As a result, the `PREVIEW` panel display will be updated according to the defined entity type and template file:
 ...
 ![Preview panel](../../_assets/user-guide/import/preview-panel.jpg)
...
![Properties panel](../../_assets/user-guide/import/properties-panel.jpg)
...
![Field mapping](../../_assets/user-guide/import/field-mapping.jpg)

To skip the unnecessary columns, select the `Skip` option in the appropriate field drop-down list:

![Field skip](../../_assets/user-guide/import/field-skip.jpg)
...
![Default values panel](../../_assets/user-guide/import/default-values-panel.jpg)
...
![Import result](../../_assets/user-guide/import/import-result.jpg)
...
![Single record actions](../../_assets/user-guide/import/single-record-actions.jpg)
...
![Not duplicate option](../../_assets/user-guide/import/not-duplicate-option.jpg) 
...
![Import revert](../../_assets/user-guide/import/import-revert.jpg)
